...
class optimalDecisionTreeClassifier:
    ...
    """
    def __init__(self, max_depth=3, min_samples_split=2, alpha=0, warmstart=True, timelimit=30, output=False):
    ...
    def _buildMIP(self, x, y):
        ...
        # (17)
        m.addConstrs(gp.quicksum((y[i][0] == k) * z[i,t] for i in range(self.n)) == M[k,t] for t in self.l_index for k in self.labels)
        # (16)
